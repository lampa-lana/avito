# Generated by Django 3.2.8 on 2021-11-19 09:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to=core.models.get_image_filename, verbose_name='изображение галереи')),
                ('post', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='post_images', to='core.post', verbose_name='изображения к объявлению')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
